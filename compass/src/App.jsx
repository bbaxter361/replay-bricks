  ...
  return (
    <div className="flex min-h-screen bg-dark-bg">
      ...
      <a
        ...
        className="fixed top-4 right-4 z-40 xl:hidden inline-flex items-center gap-1.5 px-3 py-2 rounded-full bg-white/90 backdrop-blur-sm border border-violet-200 text-xs font-medium text-violet-600 hover:bg-violet-50 hover:border-violet-300 transition-colors shadow-sm no-print"
      ...
      {/* Main Content Area */}
      <main className="flex-1 xl:ml-56 min-h-screen pb-8 pt-16 xl:pt-0">
        <Routes>
